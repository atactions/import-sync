...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!allbranches) {
            ...
            try {
                let tp = yield octokit.repos.get({ owner: context.repo.owner, repo: context.repo.repo });
                let p = yield octokit.repos.listBranches({ owner: owner, repo: tp.data.parent.name });
